...
function openBusDoor() {
    var passengersInTheBus = 28;
    var busCapacity = 30;
    var passengersToGetOnTheBus = 10;
    var leftCapacity = busCapacity - passengersInTheBus;
    return passengersToGetOnTheBus <= leftCapacity;
}
exports.openBusDoor = openBusDoor;
/**
 * Problem:
 *
...
exports.pickVehicle = pickVehicle;
 ...
 *
 */
function progressiveTaxAmount(plata) {
    var tax1 = 2;
    var tax2 = 50;
    var tax3 = 300;
    var tax4 = 600;
...
exports.progressiveTaxAmount = progressiveTaxAmount;
function progressiveTaxNextHardcoded(income) {
    var totalTax = 0;
    var leftToBeTaxed = income;
...
exports.progressiveTaxNextHardcoded = progressiveTaxNextHardcoded;
function progressiveTaxNext(income) {
    var taxes = [2, 5, 10, 12, 20, 25];
    var limits = [100, 1000, 3000, 5000, 10000];
    var totalTax = 0;
    var leftToBeTaxed = income;
    ...
    for (var i = 0; i < limits.length; i++) {
        if (leftToBeTaxed > limits[i]) {
            var taxAmount = limits[i] * taxes[i] / 100;
            totalTax += taxAmount;
            leftToBeTaxed -= limits[i];
        }
        else {
            var taxAmount = leftToBeTaxed * taxes[i] / 100;
            totalTax += taxAmount;
            leftToBeTaxed = 0;
        }
    }
...
exports.progressiveTaxNext = progressiveTaxNext;
